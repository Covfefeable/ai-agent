...
export function ModelModal({ isOpen, mode, initialData, onClose, onSuccess, isLoading: isFetchingDetail }: ModelModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      ...
      <div className="relative w-full max-w-md max-h-[85vh] flex flex-col rounded-xl bg-white shadow-2xl animate-in zoom-in-95 duration-200 overflow-hidden" onClick={(e) => e.stopPropagation()}>
